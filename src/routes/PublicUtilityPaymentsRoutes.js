...
router.put('/:id', getPublicUtilityPayment, async (req, res) => {
    try {
        ...
        console.log('next', nextPaymentFull, 'query', query, 'newGas', newGas);
